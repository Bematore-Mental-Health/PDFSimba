        ...
        <div class="row g-3">
          ...
          <div class="col-12 d-flex align-items-center">
            ...
            <label class="form-check-label">
              <a href="terms.php" target="_blank">Accept Terms & Conditions</a>
            </label>
          </div>
          <div class="col-12">
          ...
          <div class="col-12 text-center">
            <p class="mt-3">Already have an account? <a href="#" onclick="switchToLoginTab()">Log in</a></p>
          </div>
        </div>
      </form>
    </div>
...
function switchToLoginTab() {
    if (window.parent) {
        // Switch to login tab in parent window
        window.parent.postMessage({
            action: "switchToLoginTab"
...
document.querySelector('#signupFrame').src = 'modal-login.php?modal=1';
<?php endif; ?>
